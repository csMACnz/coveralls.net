...
public class TestFileSystem : IFileSystem
{
    ...
    public static string GenerateRandomAbsolutePath(params string[] paths) => Path.Combine(Path.GetFullPath(@"\"), Path.GetRandomFileName(), Path.Combine(paths));
    ...
    public void AddFile(string path, string contents) => _files[ResolvePathKey(path)] = contents;
